		<div class="fm-container">
			...
			<div class="menu">
				...
				<ul class="nav">
					...
					<li><a href="<?= url() ?>/tim-viec.html">Tìm Việc</a></li>
					<li><a href="">Tìm freelancer</a></li>
					<li><a href="#">Pages</a>
						<ul>
							<li><a href="">CV nổi bật</a></li>
							<li><a href="">Blog </a></li>
		...
		<header>
			...
			<div class="container">
				<div class="pull-left">
					<div id="logo"><a href="{{url()}}"><img src="/images/icon.png" alt="Cộng đồng freelancer lớn nhất Việt Nam" title="Cộng đồng freelancer lớn nhất Việt Nam" style="width:15%" /></a></div>
				</div>
